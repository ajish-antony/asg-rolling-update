...
## (Continous Deployment via Jenkins)
...
- For Jenkins Installation execute the script "install.sh"  for the Amazon Linux. Once the installation completes browse the URL as provided below for accessing the Jenkins.
